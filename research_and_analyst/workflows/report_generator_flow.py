...
class AutonomousReportGenerator:
    ...
    def __init__(self, llm):
        ...
        #  get actual structlog logger instance
    ...
    def create_analyst(self, state: GenerateAnalystsState):
        ...
        try:
            ...
            # ✅ FIX: use the correct Template variable
    ...
    def _save_as_docx(self, text: str, file_path: str):
        try:
            ...
            self.logger.error("couldnt save docx", path=file_path, error=str(e))
    ...
    def _save_as_pdf(self, text: str, file_path: str):
        ...
        try:
            ...
            c.save()
            self.logger.info("centered PDF saved", path=file_path)
